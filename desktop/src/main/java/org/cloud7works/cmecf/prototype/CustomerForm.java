...
public class CustomerForm extends JPanel implements ActionListener {
    ...
    JTextField email = new JTextField("yourname@uscourts.gov");
    ...
    public CustomerForm(SwingApplication application) {
        ...
        addWithCaption("Case Number:", firstName);
        addWithCaption("Filer:", lastName);
        addWithCaption("Filer Email:",  email);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == delete) {
            ...
            c.setCaseNumber(firstName.getText());
            c.setFiler(lastName.getText());
            c.setFilerEmail(email.getText());
    ...
    void editCustomer(Customer c) {
        ...
        firstName.setText(c.getCaseNumber());
        lastName.setText(c.getFiler());
        email.setText(c.getFilerEmail());
        updateButtonStates();
    }
